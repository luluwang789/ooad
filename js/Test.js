...
function showCart(){
    ...
    $("#cartList").append('<tr><td class="actions" colspan="6"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><input type="submit" id="LapPhieu" value="Lập phiếu mượn" name="proceed" class="checkout-button button alt wc-forward"></font></font></td></tr>');
}
// function showCart(){
//     for (var i=0;i< localStorage.length;++i){
//     	var key=localStorage.key(i);
